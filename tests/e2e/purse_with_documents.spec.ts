...
describe('Purse with Documents E2E', () => {
  ...
  it('should skip clarification when user specifies documents: "I lost my purse. My purse had Aadhaar and PAN."', async () => {
    const sess = `sess-purse-docs-${Date.now()}`;
    ...
    // Initial message contains purse, Aadhaar, and PAN
    const res = await chatService.sendMessage('I lost my purse. My purse had Aadhaar and PAN.', sess);

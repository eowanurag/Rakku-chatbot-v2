...
describe('Wallet Stolen E2E', () => {
  ...
  it('should detect stolen wallet and route to Lost Mobile / Theft directly', async () => {
    const sess = `sess-stolen-wallet-${Date.now()}`;
    ...
    const res = await chatService.sendMessage('My wallet was stolen.', sess);

...
describe('Complaint Submission Completion E2E Spec', () => {
  ...
  it('should successfully complete complaint submission and pass validation checks', async () => {
    const sess = `sess-completion-${Date.now()}`;

...
describe('Complaint Readiness Matrix E2E Spec', () => {
  ...
  it('should verify readiness completes when required fields are present', async () => {
    const sess = `sess-readiness-${Date.now()}`;
